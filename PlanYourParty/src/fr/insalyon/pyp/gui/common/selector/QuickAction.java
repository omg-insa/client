package fr.insalyon.pyp.gui.common.selector;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void addActionItem(ActionItem action) {
		...
		final ActionItem currentAction = action;
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
					...
					Drawable icon = currentAction.getIcon();
					img.setImageDrawable(icon);
	...
	public void reDraw(int pos) {
		View container;
		container = mTrack.getChildAt(pos);
		ImageView img = (ImageView) container.findViewById(R.id.iv_icon);
		TextView text = (TextView) container.findViewById(R.id.tv_title);
		ActionItem action = actionItems.get(pos);
		String title = action.getTitle();
		Drawable icon = action.getIcon();
		if (icon != null) {
			img.setImageDrawable(icon);
